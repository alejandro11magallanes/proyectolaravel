        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
            <div class="container mx-auto px-6 py-1 pb-16">
              <div class="bg-white shadow-md rounded my-6 p-5">
                ...
                <div class="flex flex-col space-y-2">
                    <label for="description" class="text-gray-700 select-none font-medium">Descripcion</label>
                    <textarea name="description" id="description" placeholder="Escribe la descripcion" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200" rows="5">{{ old('description',$post->description) }}</textarea>
                </div>
    
                <h3 class="text-xl my-4 text-gray-600">Selecciona el status</h3>
                <div class="grid grid-cols-3 gap-4">
                  <div class="relative inline-flex">
                    ...
                    <select class="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none" name="publish">
                      ...
                      <option value="1" @if($post->Publicar) selected @endif>Publicar</option>
                    </select>
                  </div>
                </div>
